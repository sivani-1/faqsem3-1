...
const allowedOrigins = ['http://localhost:3000', 'http://localhost:4000', 'https://yourfrontendurl.com']; // Replace with your frontend URL
app.use(cors({
...
app.post('/process_question', async (req, res) => {
  ...
  try {
    ...
    if (existingChat) {
      ...
      const apiResponse = await axios.post('https://efea-35-204-197-110.ngrok-free.app/process_question', { question }); // Replace with your Flask app URL
